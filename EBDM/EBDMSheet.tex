...
REVIEW THIS AND PARALLEL AND SERIAL
...
\textbf{Positive Likelihood Ratio (LR+): } How likely a positive test is in a pt with the disease compared to a pt without the disease \newline 
\[LR+ = \frac{\text{Sensitiviy}}{{\text{1-Specificity}}}\] \newline

\textbf{Negative Likelihood Ration (LR-): } How likely a negative test is in a pt with the disease compared to a pt without the disease
\[LR+ = \frac{\text{1-Sensitiviy}}{{\text{Specificity}}}\] \newline
...
Confounding Variable must effect both independent and dependent variable
...
\textbf{Post HOC Test: } Planned statistical analysis made after finding significance in an overall test \newline
